#!/usr/bin/python3
""" Module contains unittests for the place module """
...
class TestPlace_initialization(unittest.TestCase):
    """ Tests the initialization of instances of the Place class """

    def test_amenity_instantiation(self):
        """ Tests that object is an instance of Place """
        obj = Place()
    ...
    def test_Place_attribute_instantiation(self):
        """ Tests the initialization of attributes as datetime objects """
        obj = Place()
    ...
    def test_str_method(self):
        ...
        self.assertEqual(obj_str[:7], "[Place]")
